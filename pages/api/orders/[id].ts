    ...
    if (req.method === 'GET') {
      ...
      `, [id]);
            ...
            const orderDetail: OrderDetail = {
                ...
                клиент_краткое_название: order.клиент_краткое_название,
                клиент_полное_название: order.клиент_полное_название,
                клиент_фамилия: order.клиент_фамилия,
                клиент_имя: order.клиент_имя,
                клиент_отчество: order.клиент_отчество,
                клиент_инн: order.клиент_инн,
                клиент_кпп: order.клиент_кпп,
                клиент_огрн: order.клиент_огрн,
                клиент_огрнип: order.клиент_огрнип,
                клиент_окпо: order.клиент_окпо,
                клиент_адрес_регистрации: order.клиент_адрес_регистрации,
                клиент_адрес_печати: order.клиент_адрес_печати,
                клиент_комментарий: order.клиент_комментарий,
