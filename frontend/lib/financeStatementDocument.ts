...
const prepareFinanceStatementTemplatePayload = async (params: {
    ...
    const now = new Date();
    const documentDate = new Date(Date.UTC(now.getFullYear(), now.getMonth(), now.getDate()));
    ...
    const documentYearFull = String(documentDate.getUTCFullYear());
    const documentYearCentury = documentYearFull.slice(0, 2);
    const documentYearSuffix = documentYearFull.slice(-2);
    ...
    pushCell(cells, FIRST_SHEET_NAME, 'B18', documentDate.getUTCDate(), lineFieldStyle());
    pushCell(cells, FIRST_SHEET_NAME, 'D18', formatMonthNameRuGenitive(documentDate), lineFieldStyle());
    pushCell(cells, FIRST_SHEET_NAME, 'J18', documentYearCentury, lineFieldStyle());
    pushCell(cells, FIRST_SHEET_NAME, 'K18', documentYearSuffix, lineFieldStyle());
    pushCell(cells, FIRST_SHEET_NAME, 'BI19', statementNumber);
    pushCell(cells, FIRST_SHEET_NAME, 'BQ19', formatDateOnly(documentDate));
    ...
    pushCell(cells, SECOND_SHEET_NAME, 'CI33', documentDate.getUTCDate(), lineFieldStyle());
    pushCell(cells, SECOND_SHEET_NAME, 'CK33', formatMonthNameRuGenitive(documentDate), lineFieldStyle());
    pushCell(cells, SECOND_SHEET_NAME, 'CQ33', documentYearCentury, lineFieldStyle());
    pushCell(cells, SECOND_SHEET_NAME, 'CR33', documentYearSuffix, lineFieldStyle());
    ...
    pushCell(cells, SECOND_SHEET_NAME, 'CA36', documentDate.getUTCDate(), lineFieldStyle());
    pushCell(cells, SECOND_SHEET_NAME, 'CC36', formatMonthNameRuGenitive(documentDate), lineFieldStyle());
    pushCell(cells, SECOND_SHEET_NAME, 'CI36', documentYearCentury, lineFieldStyle());
    pushCell(cells, SECOND_SHEET_NAME, 'CJ36', documentYearSuffix, lineFieldStyle());
    ...
    if (secondPageEntries.length === 0) {
        ...
        pushCell(cells, FIRST_SHEET_NAME, 'CI39', documentDate.getUTCDate(), lineFieldStyle());
        pushCell(cells, FIRST_SHEET_NAME, 'CK39', formatMonthNameRuGenitive(documentDate), lineFieldStyle());
        pushCell(cells, FIRST_SHEET_NAME, 'CQ39', documentYearCentury, lineFieldStyle());
        pushCell(cells, FIRST_SHEET_NAME, 'CR39', documentYearSuffix, lineFieldStyle());
        ...
        pushCell(cells, FIRST_SHEET_NAME, 'CA42', documentDate.getUTCDate(), lineFieldStyle());
        pushCell(cells, FIRST_SHEET_NAME, 'CC42', formatMonthNameRuGenitive(documentDate), lineFieldStyle());
        pushCell(cells, FIRST_SHEET_NAME, 'CI42', documentYearCentury, lineFieldStyle());
        pushCell(cells, FIRST_SHEET_NAME, 'CJ42', documentYearSuffix, lineFieldStyle());
