...
import styles from './EditManagerModal.module.css';
...
export function EditManagerModal({ isOpen, manager, onClose, onManagerUpdated, canEdit }: EditManagerModalProps): JSX.Element | null {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => (!open ? handleClose() : undefined)}>
            <EntityModalShell
                ...
                description="Измените основные данные сотрудника."
            >
