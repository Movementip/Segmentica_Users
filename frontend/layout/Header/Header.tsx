...
} from '../../components/HeaderSearchPanel/HeaderSearchPanel';
    ...
    return (
        <span
            className={cn(
                ...
                weight === 'bold' && 'font-semibold text-foreground',
                className,
            )}
            {...props}
        />
...
function Separator(_props: { size?: '4' }): JSX.Element {
    return <div className={styles.searchSeparator} />;
}
    ...
    return (
        <header className={styles.header}>
            ...
            <div className={styles.rightSection}>
                ...
                <ModeToggle onThemeChange={handleThemeChange} className={styles.themeToggle} />
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" matchTriggerWidth className={styles.profileMenuContent}>
                        <DropdownMenuItem
